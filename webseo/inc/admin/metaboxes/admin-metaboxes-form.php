			...
			<div class="inside">
				...
				<div id="seopress-tabs"
					...
					if ( 'seopress_404' !== $typenow ) {
						$seo_tabs['title-tab']    = '<li><a href="#tabs-1">' . __( 'Titles settings', 'webseo' ) . '</a></li>';
						$seo_tabs['social-tab']   = '<li><a href="#tabs-2">' . __( 'Social', 'webseo' ) . '</a></li>';
						$seo_tabs['advanced-tab'] = '<li><a href="#tabs-3">' . __( 'Advanced', 'webseo' ) . '<span id="sp-advanced-alert"></span></a></li>';
					}
					$seo_tabs['redirect-tab'] = '<li><a href="#tabs-4">' . __( 'Redirection', 'webseo' ) . '</a></li>';
					...
					<div id="tabs-1">
						...
						<p class="notice notice-info">
										...
										echo wp_kses_post( sprintf( __( 'This is your <strong>Shop page</strong>. Go to <a href="%s"><strong>SEO > Titles & Metas > Archives > Products</strong></a> to edit your title and meta description.', 'webseo' ), esc_url( admin_url( 'admin.php?page=webseo-titles#tab=tab_seopress_titles_archives' ) ) ) );
										?>
						</p>
										<?php
									}
						...
						<div class="box-left">
							...
							<p>
								<span class="seopress-d-flex seopress-mb-1">
									<label for="seopress_titles_title_meta">
										<?php
											esc_html_e( 'Title', 'webseo' );
											echo seopress_tooltip( esc_html__( 'Meta title', 'webseo' ), esc_html__( 'Titles are critical to give users a quick insight into the content of a result and why it’s relevant to their query. It\'s often the primary piece of information used to decide which result to click on, so it\'s important to use high-quality titles on your web pages.', 'webseo' ), esc_html( '<title>My super title</title>' ) );
										?>
									</label>
								...
								<input id="seopress_titles_title_meta" type="text" name="seopress_titles_title"
									...
									placeholder="<?php esc_html_e( 'Enter your title', 'webseo' ); ?>"
									aria-label="<?php esc_attr_e( 'Title', 'webseo' ); ?>"
							...
							<div class="wrap-seopress-counters">
								...
								<strong><?php esc_html_e( ' / 568 pixels - ', 'webseo' ); ?></strong>
								<div id="seopress_titles_title_counters"></div>
								<?php esc_html_e( ' (maximum recommended limit)', 'webseo' ); ?>
							</div>
							...
							<div class="wrap-tags">
								...
								<button type="button" class="<?php echo esc_attr( seopress_btn_secondary_classes() ); ?> tag-title" id="seopress-tag-single-title" data-tag="%%term_title%%"><span
										class="dashicons dashicons-plus-alt2"></span><?php esc_html_e( 'Term Title', 'webseo' ); ?></button>
								<?php } else { ?>
								<button type="button" class="<?php echo esc_attr( seopress_btn_secondary_classes() ); ?> tag-title" id="seopress-tag-single-title" data-tag="%%post_title%%"><span
										class="dashicons dashicons-plus-alt2"></span><?php esc_html_e( 'Post Title', 'webseo' ); ?></button>
								<?php } ?>
								<button type="button" class="<?php echo esc_attr( seopress_btn_secondary_classes() ); ?> tag-title" id="seopress-tag-single-site-title" data-tag="%%sitetitle%%">
									<span class="dashicons dashicons-plus-alt2"></span><?php esc_html_e( 'Site Title', 'webseo' ); ?></button>
								<button type="button" class="<?php echo esc_attr( seopress_btn_secondary_classes() ); ?> tag-title" id="seopress-tag-single-sep" data-tag="%%sep%%"><span
										class="dashicons dashicons-plus-alt2"></span><?php esc_html_e( 'Separator', 'webseo' ); ?></button>
							...
							<p>
								<span class="seopress-d-flex seopress-mb-1">
									<label for="seopress_titles_desc_meta">
										<?php
											esc_html_e( 'Meta description', 'webseo' );
											echo seopress_tooltip( esc_html__( 'Meta description', 'webseo' ), wp_kses_post( __( 'A meta description tag should generally inform and interest users with a short, relevant summary of what a particular page is about. <br>They are like a pitch that convince the user that the page is exactly what they\'re looking for. <br>There\'s no limit on how long a meta description can be, but the search result snippets are truncated as needed, typically to fit the device width.', 'webseo' ) ), esc_html( '<meta name="description" content="my super meta description" />' ) );
										?>
									</label>
								...
								<textarea id="seopress_titles_desc_meta" rows="4" name="seopress_titles_desc"
									...
									placeholder="<?php esc_html_e( 'Enter your meta description', 'webseo' ); ?>"
									aria-label="<?php esc_attr_e( 'Meta description', 'webseo' ); ?>"><?php echo esc_html( $seopress_titles_desc ); ?></textarea>
							</p>
							<div class="sp-progress">
							...
							<div class="wrap-seopress-counters">
								...
								<strong><?php esc_html_e( ' / 940 pixels - ', 'webseo' ); ?></strong>
							...
							<div class="wrap-tags">
								...
								<button type="button" class="<?php echo esc_attr( seopress_btn_secondary_classes() ); ?> tag-title" id="seopress-tag-single-excerpt" data-tag="%%_category_description%%">
									<span class="dashicons dashicons-plus-alt2"></span><?php esc_html_e( 'Category / term description', 'webseo' ); ?>
								</button>
								<?php } else { ?>
								<button type="button" class="<?php echo esc_attr( seopress_btn_secondary_classes() ); ?> tag-title" id="seopress-tag-single-excerpt" data-tag="%%post_excerpt%%">
									<span class="dashicons dashicons-plus-alt2"></span><?php esc_html_e( 'Post Excerpt', 'webseo' ); ?>
								</button>
									<?php
								}
						...
						<div class="box-right">
							<div class="google-snippet-preview mobile-preview">
								<h3>
									<?php
									esc_html_e( 'Google Snippet Preview', 'webseo' );
									?>
								</h3>
								<p><?php esc_html_e( 'This is what your page will look like in Google search results. You have to publish your post to get the Google Snippet Preview. Note that Google may optionally display an image of your article.', 'webseo' ); ?>
								</p>
								<div class="wrap-toggle-preview">
									<p>
										<span class="dashicons dashicons-smartphone"></span>
										<?php esc_html_e( 'Mobile Preview', 'webseo' ); ?>
						...
						if ( array_key_exists( 'advanced-tab', $seo_tabs ) ) {
							?>
					<div id="tabs-3">
						<span class="sp-section"><?php esc_html_e( 'Meta robots settings', 'webseo' ); ?></span>
						<p class="description">
							<?php
							$url = admin_url( 'admin.php?page=webseo-titles#tab=tab_seopress_titles_single' );
								/* translators: %s: link to plugin settings page */
								echo wp_kses_post( sprintf( __( 'You cannot uncheck a parameter? This is normal, and it‘s most likely defined in the <a href="%s" class="components-button is-link">global settings of the plugin.</a>', 'webseo' ), esc_url( $url ) ) );
							?>
						</p>
						<p>
							<label for="seopress_robots_index_meta">
								...
								<?php
									echo wp_kses_post( __( 'Do not display this page in search engine results / XML - HTML sitemaps <strong>(noindex)</strong>', 'webseo' ) );
									echo seopress_tooltip( esc_html__( '"noindex" robots meta tag', 'webseo' ), wp_kses_post( __( 'By checking this option, you will add a meta robots tag with the value "noindex". <br>Search engines will not index this URL in the search results.', 'webseo' ) ), esc_html( '<meta name="robots" content="noindex" />' ) );
								?>
							</label>
						</p>
						<p>
							<label for="seopress_robots_follow_meta">
								...
								<?php
									echo wp_kses_post( __( 'Do not follow links for this page <strong>(nofollow)</strong>', 'webseo' ) );
									echo seopress_tooltip( esc_html__( '"nofollow" robots meta tag', 'webseo' ), wp_kses_post( __( 'By checking this option, you will add a meta robots tag with the value "nofollow". <br>Search engines will not follow links from this URL.', 'webseo' ) ), esc_html( '<meta name="robots" content="nofollow" />' ) );
								?>
							</label>
						</p>
						<p>
							<label for="seopress_robots_imageindex_meta">
								...
								<?php echo wp_kses_post( __( 'Do not index images for this page <strong>(noimageindex)</strong>', 'webseo' ) ); ?>
								<?php echo seopress_tooltip( esc_html__( '"noimageindex" robots meta tag', 'webseo' ), wp_kses_post( __( 'By checking this option, you will add a meta robots tag with the value "noimageindex". <br> Note that your images can always be indexed if they are linked from other pages.', 'webseo' ) ), esc_html( '<meta name="robots" content="noimageindex" />' ) ); ?>
							</label>
						</p>
						<p>
							<label for="seopress_robots_snippet_meta">
								...
								<?php echo wp_kses_post( __( 'Do not display a description in search results for this page <strong>(nosnippet)</strong>', 'webseo' ) ); ?>
								<?php echo seopress_tooltip( esc_html__( '"nosnippet" robots meta tag', 'webseo' ), wp_kses_post( __( 'By checking this option, you will add a meta robots tag with the value "nosnippet".', 'webseo' ) ), esc_html( '<meta name="robots" content="nosnippet" />' ) ); ?>
							</label>
						</p>
						<p>
							<label for="seopress_robots_canonical_meta">
								<?php
									esc_attr_e( 'Canonical URL', 'webseo' );
									echo seopress_tooltip( esc_html__( 'Canonical URL', 'webseo' ), wp_kses_post( __( 'A canonical URL is the URL of the page that Google thinks is most representative from a set of duplicate pages on your site. <br>For example, if you have URLs for the same page (for example: example.com?dress=1234 and example.com/dresses/1234), Google chooses one as canonical. <br>Note that the pages do not need to be absolutely identical; minor changes in sorting or filtering of list pages do not make the page unique (for example, sorting by price or filtering by item color). The canonical can be in a different domain than a duplicate.', 'webseo' ) ), esc_html( '<link rel="canonical" href="https://www.example.com/my-post-url/" />' ) );
								?>
							</label>
							<input id="seopress_robots_canonical_meta" type="text" name="seopress_robots_canonical"
								class="components-text-control__input"
								placeholder="<?php esc_html_e( 'Default value: ', 'webseo' ) . htmlspecialchars( urldecode( get_permalink() ) ); ?>"
								aria-label="<?php esc_attr_e( 'Canonical URL', 'webseo' ); ?>"
					...
					<div id="tabs-2">
						<div class="box-left">
							<p class="description-alt desc-fb">
								...
								<?php esc_html_e( 'LinkedIn, Instagram, WhatsApp and Pinterest use the same social metadata as Facebook. X does the same if no X Cards tags are defined below.', 'webseo' ); ?>
							</p>
							<p class="seopress-d-flex seopress-space-between">
								...
								<span>
									<a href="<?php echo esc_url( 'https://developers.facebook.com/tools/debug/sharing/?q=' . get_permalink( get_the_id() ) ); ?>"
										...
										<?php esc_html_e( 'Ask Facebook to update its cache', 'webseo' ); ?>
									</a>
								</span>
							</p>
							<p>
								<label for="seopress_social_fb_title_meta"><?php esc_html_e( 'Facebook Title', 'webseo' ); ?></label>
								<input id="seopress_social_fb_title_meta" type="text" name="seopress_social_fb_title"
									class="components-text-control__input"
									placeholder="<?php esc_html_e( 'Enter your Facebook title', 'webseo' ); ?>"
									aria-label="<?php esc_html_e( 'Facebook Title', 'webseo' ); ?>"
									value="<?php echo esc_html( $seopress_social_fb_title ); ?>" />
							</p>
							<p>
								<label for="seopress_social_fb_desc_meta"><?php esc_html_e( 'Facebook description', 'webseo' ); ?></label>
								<textarea id="seopress_social_fb_desc_meta" name="seopress_social_fb_desc"
									class="components-text-control__textarea"
									placeholder="<?php esc_html_e( 'Enter your Facebook description', 'webseo' ); ?>"
									aria-label="<?php esc_html_e( 'Facebook description', 'webseo' ); ?>"><?php echo esc_html( $seopress_social_fb_desc ); ?></textarea>
							</p>
							<p>
								<label for="seopress_social_fb_img_meta">
									<?php esc_html_e( 'Facebook Thumbnail', 'webseo' ); ?>
								</label>
								<input id="seopress_social_fb_img_meta" type="text" name="seopress_social_fb_img"
									...
									aria-label="<?php esc_html_e( 'Facebook Thumbnail', 'webseo' ); ?>"
									value="<?php echo esc_html( $seopress_social_fb_img ); ?>" />
							</p>
							<p class="description">
								<?php esc_html_e( 'Minimum size: 200x200px, ideal ratio 1.91:1, 8Mb max. (e.g. 1640x856px or 3280x1712px for retina screens)', 'webseo' ); ?>
							</p>
							<p>
						...
						<div class="box-right">
							<div class="facebook-snippet-preview">
								<h3>
									<?php esc_html_e( 'Facebook Preview', 'webseo' ); ?>
								</h3>
								<?php if ( '1' == seopress_get_toggle_option( 'social' ) ) { // phpcs:ignore -- TODO: null comparison check. ?>
								<p>
									<?php esc_html_e( 'This is what your post will look like in Facebook. You have to publish your post to get the Facebook Preview.', 'webseo' ); ?>
								</p>
								<?php } else { ?>
								<p class="notice notice-error">
									<?php esc_html_e( 'The Social Networks feature is disabled. Still seing informations from the FB Preview? You probably have social tags added by your theme or a plugin.', 'webseo' ); ?>
								</p>
								<?php } ?>
								<div class="facebook-snippet-box">
									<div class="snippet-fb-img-alert alert1" style="display:none">
										<p class="notice notice-error"><?php esc_html_e( 'File type not supported by Facebook. Please choose another image.', 'webseo' ); ?>
										</p>
									</div>
									<div class="snippet-fb-img-alert alert2" style="display:none">
										<p class="notice notice-error"><?php echo wp_kses_post( __( 'Minimum size for Facebook is <strong>200x200px</strong>. Please choose another image.', 'webseo' ) ); ?>
										</p>
									</div>
									<div class="snippet-fb-img-alert alert3" style="display:none">
										<p class="notice notice-error"><?php esc_html_e( 'File error. Please choose another image.', 'webseo' ); ?>
										</p>
									</div>
									<div class="snippet-fb-img-alert alert4" style="display:none">
										<p class="notice notice-info"><?php esc_html_e( 'Your image ratio is: ', 'webseo' ); ?><span></span>.
											<?php esc_html_e( 'The closer to 1.91 the better.', 'webseo' ); ?>
										</p>
									</div>
									<div class="snippet-fb-img-alert alert5" style="display:none">
										<p class="notice notice-error"><?php esc_html_e( 'File URL is not valid.', 'webseo' ); ?>
										</p>
									</div>
									<div class="snippet-fb-img-alert alert6" style="display:none">
										<p class="notice notice-warning"><?php esc_html_e( 'Your filesize is: ', 'webseo' ); ?><span></span>
											<?php esc_html_e( 'This is superior to 300KB. WhatsApp will not use your image.', 'webseo' ); ?>
										</p>
									</div>
									...
									<div class="facebook-snippet-text">
										<div class="snippet-meta">
											...
											<div class="fb-by"><?php esc_html_e( 'By ', 'webseo' ); ?>
											</div>
						...
						<div class="box-left">
							...
							<p>
								<label for="seopress_social_twitter_title_meta"><?php esc_html_e( 'X Title', 'webseo' ); ?></label>
								<input id="seopress_social_twitter_title_meta" type="text"
									...
									placeholder="<?php esc_html_e( 'Enter your X title', 'webseo' ); ?>"
									aria-label="<?php esc_html_e( 'X Title', 'webseo' ); ?>"
									value="<?php echo esc_html( $seopress_social_twitter_title ); ?>" />
							</p>
							<p>
								<label for="seopress_social_twitter_desc_meta"><?php esc_html_e( 'X Description', 'webseo' ); ?></label>
								<textarea id="seopress_social_twitter_desc_meta" name="seopress_social_twitter_desc"
									class="components-text-control__textarea"
									placeholder="<?php esc_html_e( 'Enter your X description', 'webseo' ); ?>"
									aria-label="<?php esc_html_e( 'X description', 'webseo' ); ?>"><?php echo esc_html( $seopress_social_twitter_desc ); ?></textarea>
							</p>
							<p>
								<label for="seopress_social_twitter_img_meta"><?php esc_html_e( 'X Thumbnail', 'webseo' ); ?></label>
							...
							<p class="description">
								<?php esc_html_e( 'Minimum size: 144x144px (300x157px with large card enabled), ideal ratio 1:1 (2:1 with large card), 5Mb max.', 'webseo' ); ?>
							</p>
							<p>
								...
								<input id="seopress_social_twitter_img_upload"
									class="<?php echo esc_attr( seopress_btn_secondary_classes() ); ?>"
									type="button"
									aria-label="<?php esc_html_e( 'X Thumbnail', 'webseo' ); ?>"
									value="<?php esc_html_e( 'Upload an Image', 'webseo' ); ?>" />
							</p>
						</div>
						<div class="box-right">
							<div class="twitter-snippet-preview">
								<h3><?php esc_html_e( 'X Preview', 'webseo' ); ?>
								</h3>
								<?php if ( '1' == seopress_get_toggle_option( 'social' ) ) { // phpcs:ignore -- TODO: null comparison check. ?>
								<p><?php esc_html_e( 'This is what your post will look like in X. You have to publish your post to get the X Preview.', 'webseo' ); ?>
								</p>
								<?php } else { ?>
								<p class="notice notice-error"><?php esc_html_e( 'The Social Networks feature is disabled. Still seing informations from the X Preview? You probably have social tags added by your theme or a plugin.', 'webseo' ); ?>
								</p>
								<?php } ?>
								<div class="twitter-snippet-box">
									<div class="snippet-twitter-img-alert alert1" style="display:none">
										<p class="notice notice-error"><?php esc_html_e( 'File type not supported by X. Please choose another image.', 'webseo' ); ?>
										</p>
									</div>
									<div class="snippet-twitter-img-alert alert2" style="display:none">
										<p class="notice notice-error"><?php echo wp_kses_post( __( 'Minimum size for X is <strong>144x144px</strong>. Please choose another image.', 'webseo' ) ); ?>
										</p>
									</div>
									...
									<div class="snippet-twitter-img-alert alert4" style="display:none">
										<p class="notice notice-info"><?php esc_html_e( 'Your image ratio is: ', 'webseo' ); ?><span></span>.
											<?php esc_html_e( 'The closer to 1 the better (with large card, 2 is better).', 'webseo' ); ?>
										</p>
									</div>
					...
					<div id="tabs-4">
						<p>
							<label for="seopress_redirections_enabled_meta" id="seopress_redirections_enabled">
								...
								/>
								<?php esc_html_e( 'Enable redirection?', 'webseo' ); ?>
							</label>
						</p>
						<?php if ( 'seopress_404' === $typenow ) { ?>
							<p>
								<label for="seopress_redirections_enabled_regex_meta" id="seopress_redirections_enabled_regex">
									...
									/>
									<?php esc_html_e( 'Regex?', 'webseo' ); ?>
								</label>
							</p>
							<p class="description">
								<a href="<?php echo esc_url( $docs['redirects']['regex'] ); ?>" class="seopress-help" target="_blank"><?php esc_html_e( 'Learn how to use regular expressions', 'webseo' ); ?></a>
								<span class="seopress-help dashicons dashicons-external"></span>
							</p>
						<?php } ?>
						<p>
							<label for="seopress_redirections_logged_status"><?php esc_html_e( 'Select a login status:', 'webseo' ); ?></label>
							...
							<select id="seopress_redirections_logged_status" name="seopress_redirections_logged_status">
								<option <?php echo selected( 'both', $seopress_redirections_logged_status ); ?>
									value="both"><?php esc_html_e( 'All', 'webseo' ); ?>
								</option>
								<option <?php echo selected( 'only_logged_in', $seopress_redirections_logged_status ); ?>
									value="only_logged_in"><?php esc_html_e( 'Only Logged In', 'webseo' ); ?>
								</option>
								<option <?php echo selected( 'only_not_logged_in', $seopress_redirections_logged_status ); ?>
									value="only_not_logged_in"><?php esc_html_e( 'Only Not Logged In', 'webseo' ); ?>
								</option>
							</select>
						</p>
						<p>

							<label for="seopress_redirections_type"><?php esc_html_e( 'Select a redirection type:', 'webseo' ); ?></label>
							...
							<select id="seopress_redirections_type" name="seopress_redirections_type">
								<option <?php echo selected( '301', $seopress_redirections_type, false ); ?>
									value="301"><?php esc_html_e( '301 Moved Permanently', 'webseo' ); ?>
								</option>
								<option <?php echo selected( '302', $seopress_redirections_type, false ); ?>
									value="302"><?php esc_html_e( '302 Found / Moved Temporarily', 'webseo' ); ?>
								</option>
								<option <?php echo selected( '307', $seopress_redirections_type, false ); ?>
									value="307"><?php esc_html_e( '307 Moved Temporarily', 'webseo' ); ?>
								</option>
								<?php if ( 'seopress_404' === $typenow ) { ?>
									<option <?php echo selected( '410', $seopress_redirections_type, false ); ?>
										value="410"><?php esc_html_e( '410 Gone', 'webseo' ); ?>
									</option>
									<option <?php echo selected( '451', $seopress_redirections_type, false ); ?>
										value="451"><?php esc_html_e( '451 Unavailable For Legal Reasons', 'webseo' ); ?>
									</option>
								<?php } ?>
							</select>
						</p>
						<p>
							<label for="seopress_redirections_value_meta"><?php esc_html_e( 'URL redirection', 'webseo' ); ?></label>
							<input id="seopress_redirections_value_meta" type="text" name="seopress_redirections_value"
								...
								placeholder="<?php esc_html_e( 'Enter your new URL in absolute (e.g. https://www.example.com/)', 'webseo' ); ?>"
								aria-label="<?php esc_html_e( 'URL redirection', 'webseo' ); ?>"
								value="<?php echo esc_url( $seopress_redirections_value ); ?>" />
						</p>
						<p class="description">
							<?php esc_html_e( 'Enter some keywords to auto-complete this field against your content.', 'webseo' ); ?>
						</p>
						...
						<?php if ( 'seopress_404' === $typenow ) { ?>
						<p>
							<label for="seopress_redirections_param_meta"><?php esc_html_e( 'Query parameters', 'webseo' ); ?></label>
							<select name="seopress_redirections_param">
								<option <?php echo selected( 'exact_match', $seopress_redirections_param, false ); ?>
									value="exact_match"><?php esc_html_e( 'Exactly match all parameters', 'webseo' ); ?>
								</option>
								<option <?php echo selected( 'without_param', $seopress_redirections_param, false ); ?>
									value="without_param"><?php esc_html_e( 'Exclude all parameters', 'webseo' ); ?>
								</option>
								<option <?php echo selected( 'with_ignored_param', $seopress_redirections_param, false ); ?>
									value="with_ignored_param"><?php esc_html_e( 'Exclude all parameters and pass them to the redirection', 'webseo' ); ?>
								</option>
							</select>
						</p>
						<?php } ?>
						<p>
							...
							<a href="<?php echo esc_url( $href ); ?>"
								...
								class="<?php echo esc_attr( seopress_btn_secondary_classes() ); ?>"
								target="_blank">
										<?php esc_html_e( 'Test your URL', 'webseo' ); ?>
							</a>
										<?php
									}
								}
							...
							<a href="<?php echo esc_url( $docs['redirects']['enable'] ); ?>"
								target="_blank" class="seopress-help seopress-doc">
										<?php esc_html_e( 'Need help with your redirections? Read our guide', 'webseo' ); ?>
							</a>
							<span class="seopress-help dashicons dashicons-external"></span>
								<?php } ?>
						</p>
