	...
	<aside id="seopress-activity-panel" class="seopress-activity-panel">
		<div role="tablist" aria-orientation="horizontal" class="seopress-activity-panel-tabs">
            <?php if ( 'webseo-option' === $page ) { ?>
				<button type="button" role="tab" aria-selected="true" aria-label="<?php esc_html_e( 'Display', 'webseo' ); ?>" title="<?php esc_html_e( 'Display', 'webseo' ); ?>" id="activity-panel-tab-display" data-panel="display" class="btn">
					...
					<span class="screen-reader-text"><?php esc_html_e( 'Display', 'webseo' ); ?></span>
				</button>
			<?php } ?>
			<button type="button" role="tab" aria-selected="true" aria-label="<?php esc_html_e( 'Help', 'webseo' ); ?>" title="<?php esc_html_e( 'Help', 'webseo' ); ?>" id="activity-panel-tab-help" data-panel="help" class="btn">
				...
				<span class="screen-reader-text"><?php esc_html_e( 'Help', 'webseo' ); ?></span>
			</button>
			<button type="button" role="tab" aria-selected="true" aria-label="<?php esc_html_e( 'Notifications', 'webseo' ); ?>" title="<?php esc_html_e( 'Notifications', 'webseo' ); ?>" id="activity-panel-tab-notifications" data-panel="notifications" class="btn">
			<svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				?>
				<span class="screen-reader-text"><?php esc_html_e( 'Notifications', 'webseo' ); ?></span>
			</button>
		</div>
		<div id="seopress-activity-panel-help" class="seopress-activity-panel-wrapper" tabindex="0" role="tabpanel"
			...
			<div id="activity-panel-true">
				<div class="seopress-activity-panel-header">
					<div class="seopress-inbox-title">
						<h2><?php esc_html_e( 'Documentation', 'webseo' ); ?></h2>
					</div>
				</div>
				<div class="seopress-activity-panel-content">
					<form action="<?php echo esc_url( $docs['website'] ); ?>" method="get" class="seopress-search" target="_blank">
						<label for="seopress-search" class="screen-reader-text"><?php esc_html_e( 'Search', 'webseo' ); ?></label>
						<input class="adminbar-input" id="seopress-search" name="s" type="text" value="" placeholder="<?php esc_html_e( 'Search our documentation', 'webseo' ); ?>" maxlength="150">
						<input type="submit" class="btn btnSecondary" value="<?php esc_html_e( 'Search', 'webseo' ); ?>">
					</form>

					<div class="seopress-panel-section">
						<h2><?php esc_html_e( 'Get started guides', 'webseo' ); ?></h2>
					...
					<div class="seopress-panel-section">
						<h2><?php esc_html_e( 'By product', 'webseo' ); ?></h2>
						<p><?php esc_html_e( 'Quickly filter our documentation by a specific plugin.', 'webseo' ); ?></p>
						<div class="seopress-products">
                                                        <a href="<?php echo esc_url( $docs['support-free'] ); ?>" title="<?php esc_html_e( 'SEOPress Free documentation (new window)', 'webseo' ); ?>" target="_blank">
                                                                <img src="<?php echo esc_url( WEBSEO_ASSETS_DIR . '/img/support-webseo-free.svg' ); ?>" width="291" height="81" alt="SEOPress Free"/>
                                                        </a>
                                                        <a href="<?php echo esc_url( $docs['support-pro'] ); ?>" title="<?php esc_html_e( 'SEOPress PRO documentation (new window)', 'webseo' ); ?>" target="_blank">
                                                                <img src="<?php echo esc_url( WEBSEO_ASSETS_DIR . '/img/support-webseo-pro.svg' ); ?>" width="291" height="81" alt="SEOPress PRO"/>
                                                        </a>
                                                        <a href="<?php echo esc_url( $docs['support-insights'] ); ?>" title="<?php esc_html_e( 'SEOPress Insights documentation (new window)', 'webseo' ); ?>" target="_blank">
					...
					<div class="seopress-panel-section">
						<h2><span class="dashicons dashicons-translation"></span><?php esc_html_e( 'Translations', 'webseo' ); ?></h2>
						<p><?php esc_html_e( 'The plugin is translated into dozens of languages.', 'webseo' ); ?></p>
						<p><?php echo /* translators: %s: admin Updates URL */ wp_kses_post( sprintf( __( 'Go to <a href="%s">Updates</a> and click <strong>Update translations</strong> button to get the latest available translations for your language.', 'webseo' ), esc_url( admin_url( 'update-core.php' ) ) ) ); ?></p>
						<p><?php esc_html_e( 'Your translation is missing? Contribute to SEOPress now!', 'webseo' ); ?></p>
						<a href="<?php echo esc_url( $docs['i18n'] ); ?>" class="btn btnSecondary" title="<?php esc_html_e( 'Learn how to translate the plugin in your own language', 'webseo' ); ?>" target="_blank">
							<?php esc_html_e( 'Translate SEOPress', 'webseo' ); ?>
							<span class="dashicons dashicons-external"></span>
						</a>
					</div>

					<div class="seopress-panel-section">
						<h2><?php esc_html_e( 'Open a support ticket', 'webseo' ); ?></h2>
						<p><?php esc_html_e( 'Can‘t find the info you‘re looking for?', 'webseo' ); ?></p>
						<a href="<?php echo esc_url( $docs['support-tickets'] ); ?>" class="btn btnSecondary" title="<?php esc_html_e( 'Open a support ticket on SEOPress.org website (new window)', 'webseo' ); ?>" target="_blank">
							<?php esc_html_e( 'Open a support ticket', 'webseo' ); ?>
							<span class="dashicons dashicons-external"></span>
						</a>
					</div>
				</div>
			...
			<div id="seopress-activity-panel-display" class="seopress-activity-panel-wrapper" tabindex="0" role="popover" aria-label="Display">
				<div id="activity-panel-true">
					<div class="seopress-activity-panel-header">
						<div class="seopress-inbox-title">
							<h2><?php esc_html_e( 'Choose the way it looks', 'webseo' ); ?></h2>
						</div>
					</div>
					<div class="seopress-activity-panel-content seopress-activity-panel-options">
						<h3>
							<?php esc_html_e( 'Show / Hide your dashboard blocks:', 'webseo' ); ?>
						</h3>
						...
						<p>
							...
							<label for="notice-get-started">
								<?php esc_html_e( 'Hide Get started?', 'webseo' ); ?>
							</label>
						</p>
						...
						<p>
							...
							<label for="notice-tasks">
								<?php esc_html_e( 'Hide SEO Suite?', 'webseo' ); ?>
							</label>
						</p>
						...
						<p>
							...
							<label for="seopress_advanced_option_name[seopress_advanced_appearance_seo_tools]">
								<?php esc_html_e( 'Hide Site Overview?', 'webseo' ); ?>
							</label>
						</p>
						...
						<p>
							...
							<label for="seopress_advanced_option_name[seopress_advanced_appearance_notifications]">
								<?php esc_html_e( 'Hide Notifications Center?', 'webseo' ); ?>
							</label>
						</p>
						...
						<p>
							...
							<label for="notice-ebooks">
								<?php esc_html_e( 'Hide SEO Ebooks?', 'webseo' ); ?>
							</label>
						</p>
						...
						<p>
							...
							<label for="notice-integrations">
								<?php esc_html_e( 'Hide Integrations?', 'webseo' ); ?>
							</label>
						</p>
						...
						<p>
							...
							<label for="seopress_advanced_option_name[seopress_advanced_appearance_news]">
								<?php esc_html_e( 'Hide SEO News?', 'webseo' ); ?>
							</label>
						</p>
					</div>
				</div>
			...
			<div id="activity-panel-true">
				<div class="seopress-activity-panel-header">
					<div class="seopress-inbox-title">
						...
						echo wp_kses_post( sprintf( __( 'Notifications <span>(%d)</span>', 'webseo' ), absint( $total ) ) );
						?>
						</h2>
						<a href="#seopress-hidden-notifications" class="btnLink"><?php esc_html_e( 'Show hidden', 'webseo' ); ?></a>
					</div>
				</div>
				<div class="seopress-activity-panel-content">
					<?php
