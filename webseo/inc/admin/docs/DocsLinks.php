...
function seopress_get_docs_links() {
	...
	$docs = array(
		...
		'get_started_insights' => array(
			'installation'  => array( __( 'Activate your SEOPress Insights license', 'webseo' ) => 'https://www.seopress.org/support/guides/activate-seopress-pro-license/' ),
			'track_kw'      => array( __( 'Track your keyword rankings in Google with SEOPress Insights', 'webseo' ) => 'https://www.seopress.org/support/guides/track-keyword-rankings-google-seopress-insights/' ),
			'track_bl'      => array( __( 'Monitor and analyse your Backlinks with SEOPress Insights', 'webseo' ) => 'https://www.seopress.org/support/guides/monitor-and-analyse-your-backlinks-with-seopress-insights/' ),
			'find_kw'       => array( __( 'Finding SEO keywords for your WordPress site', 'webseo' ) => 'https://www.seopress.org/support/tutorials/finding-seo-keywords-for-your-blog/' ),
			'optimize_kw'   => array( __( 'Optimize WordPress posts for a keyword', 'webseo' ) => 'https://www.seopress.org/support/tutorials/optimize-wordpress-posts-for-a-keyword/' ),
			'audit_bl'      => array( __( 'Audit the backlinks of your WordPress site (in WordPress)', 'webseo' ) => 'https://www.seopress.org/support/tutorials/audit-the-backlinks-of-your-wordpress-site-in-wordpress/' ),
			'importance_bl' => array( __( 'The importance of backlinks', 'webseo' ) => 'https://www.seopress.org/support/tutorials/the-importance-of-backlinks/' ),
		),
		'universal'            => array(
