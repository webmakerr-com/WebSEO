...
add_settings_section(
	...
	'',
	// __("Knowledge graph","webseo"), // Title.
...
add_settings_field(
	...
	__( 'Person or organization', 'webseo' ), // Title.
...
add_settings_field(
	...
	__( 'Your name/organization', 'webseo' ), // Title.
...
add_settings_field(
	...
	__( 'Your photo/organization logo', 'webseo' ), // Title.
...
add_settings_field(
	...
	__( "Organization's phone number", 'webseo' ), // Title.
...
add_settings_field(
	...
	__( 'Contact option', 'webseo' ), // Title.
...
add_settings_field(
	...
	'<img class="seopress-social-icon" src="' . esc_url( WEBSEO_URL_ASSETS . '/img/social/facebook.svg' ) . '" alt="Facebook" width="24" height="24"> ' . __( 'Facebook page URL', 'webseo' ), // Title.
...
add_settings_field(
	...
	'<img class="seopress-social-icon" src="' . esc_url( WEBSEO_URL_ASSETS . '/img/social/x.svg' ) . '" alt="X" width="24" height="24"> ' . __( 'X Username', 'webseo' ), // Title.
...
add_settings_field(
	...
	'<img class="seopress-social-icon" src="' . esc_url( WEBSEO_URL_ASSETS . '/img/social/pinterest.svg' ) . '" alt="Pinterest" width="24" height="24"> ' . __( 'Pinterest URL', 'webseo' ), // Title.
...
add_settings_field(
	...
	'<img class="seopress-social-icon" src="' . esc_url( WEBSEO_URL_ASSETS . '/img/social/instagram.svg' ) . '" alt="Instagram" width="24" height="24"> ' . __( 'Instagram URL', 'webseo' ), // Title.
...
add_settings_field(
	...
	'<img class="seopress-social-icon" src="' . esc_url( WEBSEO_URL_ASSETS . '/img/social/youtube.svg' ) . '" alt="YouTube" width="24" height="24"> ' . __( 'YouTube URL', 'webseo' ), // Title.
...
add_settings_field(
	...
	'<img class="seopress-social-icon" src="' . esc_url( WEBSEO_URL_ASSETS . '/img/social/linkedin.svg' ) . '" alt="LinkedIn" width="24" height="24"> ' . __( 'LinkedIn URL', 'webseo' ), // Title.
...
add_settings_field(
	...
	__( 'Additional accounts', 'webseo' ), // Title.
...
add_settings_field(
	...
	__( 'Enable Open Graph Data', 'webseo' ), // Title.
...
add_settings_field(
	...
	__( 'Select a default image', 'webseo' ), // Title.
...
add_settings_field(
	...
	__( 'Apply this image to all your og:image tag', 'webseo' ), // Title.
...
add_settings_field(
	...
	__( 'Define custom og:image tag for post type archive pages', 'webseo' ), // Title.
...
add_settings_field(
	...
	__( 'Facebook Link Ownership ID', 'webseo' ), // Title.
...
add_settings_field(
	...
	__( 'Facebook Admin ID', 'webseo' ), // Title.
...
add_settings_field(
	...
	__( 'Facebook App ID', 'webseo' ), // Title.
...
add_settings_field(
	...
	__( 'Enable X Cards', 'webseo' ), // Title.
...
add_settings_field(
	...
	__( 'Use Open Graph if no X Cards is filled', 'webseo' ), // Title.
...
add_settings_field(
	...
	__( 'Default X Image', 'webseo' ), // Title.
...
add_settings_field(
	...
	__( 'Image size for X Summary card', 'webseo' ), // Title.
...
add_settings_field(
	...
	__( 'Post thumbnail image size', 'webseo' ), // Title.
...
add_settings_field(
	...
	__( 'Display Fediverse Creator tag', 'webseo' ), // Title.
