...
class CountTargetKeywordsUse {
        ...
        public function getCountByKeywords( $target_keywords, $post_id = null ) { // phpcs:ignore -- TODO: check if method is outside this class before renaming.
                ...
                $transient_key    = 'webseo_content_analysis_count_target_keywords_use_' . $hashed;
                $legacy_transient = 'seopress_content_analysis_count_target_keywords_use_' . $hashed;
                $cached           = get_transient( $transient_key );

                if ( false === $cached ) {
                        $cached = get_transient( $legacy_transient );
