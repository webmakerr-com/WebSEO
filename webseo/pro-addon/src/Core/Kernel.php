...
abstract class Kernel
{
    ...
    public static function execute($data) {
        ...
        add_action('plugins_loaded', [__CLASS__, 'handleHooksPlugin'], 20);
        register_activation_hook($data['file'], [__CLASS__, 'handleHooksPlugin'], 20);
        register_deactivation_hook($data['file'], [__CLASS__, 'handleHooksPlugin'], 20);
    }
}
