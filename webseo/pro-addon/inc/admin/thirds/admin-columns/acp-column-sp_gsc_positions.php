...
class ACP_Column_sp_gsc_positions extends AC\Column\Meta
	implements \ACP\Sorting\Sortable, \ACP\Export\Exportable, \ACP\Search\Searchable {

	public function __construct() {
		$this->set_type( 'column-sp_gsc_positions' );
		$this->set_group( 'seopress' );
		$this->set_label( __( 'Position', 'webseo' ) );
	}

	public function get_meta_key() {
		return '_seopress_search_console_analysis_position';
	}
