...
<div class="wrap-rich-snippets-recipes">
    <div class="seopress-notice">
        <p>
            <?php
                ...
                echo wp_kses_post(sprintf(__('Learn more about the <strong>Recipe schema</strong> from the <a href="%s" target="_blank">Google official documentation website</a>', 'webseo'), 'https://developers.google.com/search/docs/data-types/recipe'));
            ?>
    ...
    <p>
        ...
        <span class="description"><?php esc_html_e('The name of your dish', 'webseo'); ?></span>
    </p>
    <p>
        <label for="seopress_pro_rich_snippets_recipes_desc_meta"><?php esc_html_e('Short recipe description', 'webseo'); ?>
            <code>description</code>
        </label>
        <?php echo seopress_schemas_mapping_array('seopress_pro_rich_snippets_recipes_desc', 'default'); ?>
        <span class="description"><?php esc_html_e('A short summary describing the dish.', 'webseo'); ?></span>
    </p>
    <p>
        ...
        <span class="description"><?php esc_html_e('e.g. appetizer, entree, or dessert', 'webseo'); ?></span>
    </p>
    <p>
        <label for="seopress_pro_rich_snippets_recipes_img_meta"><?php esc_html_e('Image', 'webseo'); ?>
            <code>image</code>
        </label>
    ...
    <p>
        <label for="seopress_pro_rich_snippets_recipes_video_meta"><?php esc_html_e('Video URL of the recipe', 'webseo'); ?>
            <code>video</code>
        </label>
        <?php echo seopress_schemas_mapping_array('seopress_pro_rich_snippets_recipes_video', 'default'); ?>
        <span class="description"><?php esc_html_e('A video URL describing the recipe preparation', 'webseo'); ?></span>
    </p>
    <p>
        ...
        <span class="description"><?php esc_html_e('e.g. 30 min', 'webseo'); ?></span>
    </p>
    <p>
        ...
        <span class="description"><?php esc_html_e('e.g. 45 min', 'webseo'); ?></span>
    </p>
    <p>
        ...
        <span class="description"><?php esc_html_e('Number of calories', 'webseo'); ?></span>
    </p>
    <p>
        ...
        <span class="description"><?php esc_html_e('e.g. number of people served, or number of servings', 'webseo'); ?></span>
    </p>
    <p>
        ...
        <span class="description"><?php esc_html_e('e.g. winter apple pie, nutmeg crust (NOT recommended: dessert, American)', 'webseo'); ?></span>
    </p>
    <p>
        ...
        <span class="description"><?php esc_html_e('The region associated with your recipe. For example, "French", Mediterranean", or "American".', 'webseo'); ?></span>
    </p>
    <p>
        ...
        <span class="description"><?php esc_html_e('Ingredients used in the recipe. One ingredient per line. Include only the ingredient text that is necessary for making the recipe. Don\'t include unnecessary information, such as a definition of the ingredient.', 'webseo'); ?></span>
    </p>
    <p>
        ...
        <span class="description"><?php esc_html_e('e.g. Heat oven to 425°F. Include only text on how to make the recipe and don\'t include other text such as "Directions", "Watch the video", "Step 1".', 'webseo'); ?></span>
    </p>
</div>
