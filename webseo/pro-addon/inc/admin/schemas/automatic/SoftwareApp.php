...
<div class="wrap-rich-snippets-software-app">
	<div class="seopress-notice">
		<p>
			<?php
				...
				echo wp_kses_post(sprintf(__('Learn more about the <strong>Software App schema</strong> from the <a href="%s" target="_blank">Google official documentation website</a>', 'webseo'), 'https://developers.google.com/search/docs/data-types/software-app'));
			?>
	...
	<p>
		...
		<span
			class="description"><?php esc_html_e('The name of your app', 'webseo'); ?></span>
	</p>
	<p>
		<label for="seopress_pro_rich_snippets_softwareapp_os_meta">
			<?php esc_html_e('Operating system', 'webseo'); ?>
			<code>operatingSystem</code>
		</label>
		<?php echo seopress_schemas_mapping_array('seopress_pro_rich_snippets_softwareapp_os', 'default'); ?>
		<span
			class="description"><?php esc_html_e('The operating system(s) required to use the app', 'webseo'); ?></span>
	</p>
	<p>
	...
	<p>
		...
		<span
			class="description"><?php esc_html_e('The price of your app (set "0" if the app is free of charge)', 'webseo'); ?></span>
	</p>
	<p>
	...
	<p>
		...
		<span
			class="description"><?php esc_html_e('The item rating', 'webseo'); ?></span>
	</p>
	<p>
		...
		<span
			class="description"><?php esc_html_e('Only required if your scale is different from 1 to 5.', 'webseo'); ?></span>
	</p>
</div>
