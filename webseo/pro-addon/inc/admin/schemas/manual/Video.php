...
<div class="wrap-rich-snippets-item wrap-rich-snippets-videos">
    <div class="seopress-notice">
        <p>
            <?php esc_html_e('Mark up your video content with structured data to make Google Search an entry point for discovering and watching videos. ', 'webseo'); ?>
        </p>
    </div>
    <p>
        ...
        <input type="text" id="seopress_pro_rich_snippets_videos_name_meta"
            ...
            placeholder="<?php esc_html_e('The title of your video', 'webseo'); ?>"
            aria-label="<?php esc_html_e('Video name', 'webseo'); ?>"
            value="<?php echo esc_attr($seopress_pro_rich_snippets_videos_name); ?>" />
    </p>
    <p>
        <label for="seopress_pro_rich_snippets_videos_description_meta"><?php esc_html_e('Video description', 'webseo'); ?>
        </label>
        <textarea id="seopress_pro_rich_snippets_videos_description_meta"
            ...
            placeholder="<?php esc_html_e('The description of the video', 'webseo'); ?>"
            aria-label="<?php esc_html_e('Video description', 'webseo'); ?>"><?php echo wp_kses_post($seopress_pro_rich_snippets_videos_description); ?></textarea>
    </p>
    <p>
        <label for="seopress-date-picker4">
            <?php esc_html_e('Uploaded date', 'webseo'); ?>
        </label>
        <input type="text" id="seopress-date-picker4" class="seopress-date-picker" autocomplete="off"
            ...
            placeholder="<?php esc_html_e('The uploaded date of your video in ISO 8601 format. For example, "2017-01-24" or "2017-01-24T19:33:17+00:00".', 'webseo'); ?>"
            aria-label="<?php esc_html_e('Published date', 'webseo'); ?>"
            value="<?php echo esc_attr($seopress_pro_rich_snippets_videos_date_posted); ?>" />
    </p>
    <p>
        <label for="seopress_pro_rich_snippets_videos_img_meta"><?php esc_html_e('Video thumbnail', 'webseo'); ?>
        </label>
        <span class="description"><?php esc_html_e('Minimum size: 160px by 90px - Max size: 1920x1080px - crawlable and indexable', 'webseo'); ?></span>
    ...
    <p>
        ...
        <input type="text" id="seopress_pro_rich_snippets_videos_duration_meta"
            ...
            placeholder="<?php esc_html_e('e.g. 00:04:30 for 4 minutes and 30 seconds', 'webseo'); ?>"
            aria-label="<?php esc_html_e('Duration of your video (format: hh:mm:ss)', 'webseo'); ?>"
            value="<?php echo esc_attr($seopress_pro_rich_snippets_videos_duration); ?>" />
        <span class="description"><?php esc_html_e('You must respect the format of this field: hh:mm:ss', 'webseo'); ?></span>
    </p>
    <p>
        ...
        <input type="text" id="seopress_pro_rich_snippets_videos_url_meta"
            ...
            placeholder="<?php esc_html_e('e.g. https://example.com/video.mp4', 'webseo'); ?>"
