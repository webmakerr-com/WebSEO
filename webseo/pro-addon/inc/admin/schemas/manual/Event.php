...
<div class="wrap-rich-snippets-item wrap-rich-snippets-events">
	<div class="seopress-notice">
		<p>
			<?php esc_html_e('Event markup describes the details of organized events. When you use it in your content, that event becomes relevant for enhanced search results for relevant queries.', 'webseo'); ?>
		</p>
	</div>
	...
	<div class="seopress-notice is-warning">
		<ul class="advice seopress-list">
			<li>
				<?php esc_html_e('Expired events. Events data for any feature will never be shown for expired events. However, you do not have to remove markup for expired events.', 'webseo'); ?>
			</li>
			<li>
				<?php esc_html_e('Indicate the performer. Each event item must specify a performer property corresponding to the event\'s performer; that is, a musician, musical group, presenter, actor, and so on.', 'webseo'); ?>
			</li>
			<li>
				<?php esc_html_e('Do not include promotional elements in the name.', 'webseo'); ?>
			</li>
			<ul class="sublist">
				<li>
					<span class="dashicons dashicons-no"></span><?php esc_html_e('Promoting non-event products or services: "Trip package: San Diego/LA, 7 nights"', 'webseo'); ?>
				</li>
				<li>
					<span class="dashicons dashicons-no"></span><?php esc_html_e('Prices in event titles: "Music festival - only $10!" Instead, highlight ticket prices using the tickets property in your markup.', 'webseo'); ?>
				</li>
				<li>
					<span class="dashicons dashicons-no"></span><?php esc_html_e('Using a non-event for a title, such as: "Sale on dresses!"', 'webseo'); ?>
				</li>
				<li>
					<span class="dashicons dashicons-no"></span><?php esc_html_e('Discounts or purchase opportunties, such as: "Concert - buy your tickets now," or "Concert - 50 percent off until Saturday!"', 'webseo'); ?>
				</li>
			</ul>
			<li>
	...
	<p>
		...
		<input type="text" id="seopress_pro_rich_snippets_events_name_meta"
			...
			placeholder="<?php esc_html_e('The name of your event', 'webseo'); ?>"
			aria-label="<?php esc_html_e('Event name', 'webseo'); ?>"
	...
	<p>
		...
		<textarea id="seopress_pro_rich_snippets_events_desc"
			...
			placeholder="<?php esc_html_e('Enter your event description', 'webseo'); ?>"
			aria-label="<?php esc_html_e('Event description', 'webseo'); ?>"><?php echo wp_kses_post($seopress_pro_rich_snippets_events_desc); ?></textarea>
	</p>
	<p>
	...
	<p>
		...
		<input type="text" id="seopress-date-picker1" class="seopress-date-picker" autocomplete="off"
			...
			aria-label="<?php esc_html_e('Start date', 'webseo'); ?>"
	...
	<p>
		<label for="seopress_pro_rich_snippets_events_start_date_timezone_meta">
			<?php esc_html_e('Timezone', 'webseo'); ?>
		</label>
		<input type="text" id="seopress_pro_rich_snippets_events_start_date_timezone_meta"
			...
			placeholder="<?php esc_html_e('e.g. -4:00', 'webseo'); ?>"
			aria-label="<?php esc_html_e('Timezone', 'webseo'); ?>"
	...
	<p>
		...
		<input type="text" id="seopress_pro_rich_snippets_events_start_time_meta"
			...
			aria-label="<?php esc_html_e('Start time', 'webseo'); ?>"
	...
	<p>
		...
		<input type="text" id="seopress-date-picker2" class="seopress-date-picker" autocomplete="off"
			...
			placeholder="<?php esc_html_e('e.g. YYYY-MM-DD', 'webseo'); ?>"
			aria-label="<?php esc_html_e('End date', 'webseo'); ?>"
	...
	<p>
		...
		<input type="text" id="seopress_pro_rich_snippets_events_end_time_meta"
			...
			placeholder="<?php esc_html_e('e.g. HH:MM', 'webseo'); ?>"
			aria-label="<?php esc_html_e('End time', 'webseo'); ?>"
	...
	<p>
		...
		<input type="text" id="seopress-date-picker7" class="seopress-date-picker" autocomplete="off"
			...
			placeholder="<?php esc_html_e('e.g. YYYY-MM-DD', 'webseo'); ?>"
			aria-label="<?php esc_html_e('Previous start date', 'webseo'); ?>"
	...
	<p>
		...
		<input type="text" id="seopress_pro_rich_snippets_events_previous_start_time_meta"
			...
			placeholder="<?php esc_html_e('e.g. HH:MM', 'webseo'); ?>"
			aria-label="<?php esc_html_e('Previous start time', 'webseo'); ?>"
	...
	<p>
		...
		<input type="text" id="seopress_pro_rich_snippets_events_location_name_meta"
			...
			placeholder="<?php esc_html_e('e.g. My Local Business name', 'webseo'); ?>"
			aria-label="<?php esc_html_e('Location name', 'webseo'); ?>"
	...
	<p>
		...
		<input type="text" id="seopress_pro_rich_snippets_events_location_url_meta"
			...
			aria-label="<?php esc_html_e('Event website', 'webseo'); ?>"
	...
	<p>
		...
		<input type="text" id="seopress_pro_rich_snippets_events_location_address_meta"
			...
			placeholder="<?php esc_html_e('e.g. 1 Avenue de l\'Imperatrice, 64200 Biarritz', 'webseo'); ?>"
			aria-label="<?php esc_html_e('Location Address', 'webseo'); ?>"
	...
	<p>
		...
		<input type="text" id="seopress_pro_rich_snippets_events_offers_name_meta"
			...
			aria-label="<?php esc_html_e('Offer name', 'webseo'); ?>"
			placeholder="<?php esc_html_e('e.g. General admission', 'webseo'); ?>"
			value="<?php echo esc_attr($seopress_pro_rich_snippets_events_offers_name); ?>" />
	</p>
	<p>
		<label for="seopress_pro_rich_snippets_events_offers_cat_meta"><?php esc_html_e('Select your offer category', 'webseo'); ?>
		</label>
	...
	<p>
		...
		<input type="text" id="seopress_pro_rich_snippets_events_offers_price_meta"
			...
			placeholder="<?php esc_html_e('e.g. 10', 'webseo'); ?>"
			aria-label="<?php esc_html_e('Price', 'webseo'); ?>"
			value="<?php echo esc_attr($seopress_pro_rich_snippets_events_offers_price); ?>" />
		<span class="description">
			<?php esc_html_e('The lowest available price, including service charges and fees, of this type of ticket.', 'webseo'); ?>
		</span>
	</p>
	<p>
		<label for="seopress_pro_rich_snippets_events_offers_price_currency_meta"><?php esc_html_e('Select your currency', 'webseo'); ?>
		</label>
	...
	<p>
		<label for="seopress_pro_rich_snippets_events_offers_availability_meta"><?php esc_html_e('Availability', 'webseo'); ?>
		</label>
	...
	<p>
		...
		<input type="text" id="seopress-date-picker3" class="seopress-date-picker" autocomplete="off"
			...
			aria-label="<?php esc_html_e('The date when tickets go on sale', 'webseo'); ?>"
			value="<?php echo esc_attr($seopress_pro_rich_snippets_events_offers_valid_from_date); ?>" />

		<span class="description">
			<?php esc_html_e('The date when tickets go on sale', 'webseo'); ?>
		</span>
	</p>
	<p>
		...
		<input type="time" id="seopress_pro_rich_snippets_events_offers_valid_from_meta_time"
			...
			aria-label="<?php esc_html_e('The time when tickets go on sale', 'webseo'); ?>"
	...
	<p>
		...
		<input type="text" id="seopress_pro_rich_snippets_events_offers_url_meta"
			...
			placeholder="<?php esc_html_e('e.g. https://www.example.com', 'webseo'); ?>"
			aria-label="<?php esc_html_e('Website to buy tickets', 'webseo'); ?>"
	...
	<p>
		...
		<input type="text" id="seopress_pro_rich_snippets_events_performer_meta"
			...
			placeholder="<?php esc_html_e('e.g. Lana Del Rey', 'webseo'); ?>"
			aria-label="<?php esc_html_e('Performer name', 'webseo'); ?>"
	...
	<p>
		...
		<input type="text" id="seopress_pro_rich_snippets_events_organizer_name_meta"
			...
			placeholder="<?php esc_html_e('e.g. Apple', 'webseo'); ?>"
			aria-label="<?php esc_html_e('Organizer name', 'webseo'); ?>"
	...
	<p>
		...
		<input type="text" id="seopress_pro_rich_snippets_events_organizer_url_meta"
			...
			placeholder="<?php esc_html_e('e.g. https://www.example.com', 'webseo'); ?>"
			aria-label="<?php esc_html_e('Organizer URL', 'webseo'); ?>"
			value="<?php echo esc_url($seopress_pro_rich_snippets_events_organizer_url); ?>" />
	</p>
	<p>
		<label for="seopress_pro_rich_snippets_events_status_meta"><?php esc_html_e('Select your event status', 'webseo'); ?>
		</label>
		<select id="seopress_pro_rich_snippets_events_status_meta"
			...
			<option <?php selected('none', $seopress_pro_rich_snippets_events_status); ?>
				value="none"><?php esc_html_e('Select a status event', 'webseo'); ?>
			</option>
			<option <?php selected('EventCancelled', $seopress_pro_rich_snippets_events_status); ?>
				value="EventCancelled"><?php esc_html_e('Event cancelled', 'webseo'); ?>
			</option>
			<option <?php selected('EventMovedOnline', $seopress_pro_rich_snippets_events_status); ?>
				value="EventMovedOnline"><?php esc_html_e('Event moved online', 'webseo'); ?>
			</option>
			<option <?php selected('EventPostponed', $seopress_pro_rich_snippets_events_status); ?>
				value="EventPostponed"><?php esc_html_e('Event postponed', 'webseo'); ?>
			</option>
			<option <?php selected('EventRescheduled', $seopress_pro_rich_snippets_events_status); ?>
				value="EventRescheduled"><?php esc_html_e('Event rescheduled', 'webseo'); ?>
			</option>
			<option <?php selected('EventScheduled', $seopress_pro_rich_snippets_events_status); ?>
				value="EventScheduled"><?php esc_html_e('Event scheduled', 'webseo'); ?>
			</option>
		</select>
	</p>
	<p>
		<label for="seopress_pro_rich_snippets_events_attendance_mode_meta"><?php esc_html_e('Select your event attendance mode', 'webseo'); ?>
		</label>
