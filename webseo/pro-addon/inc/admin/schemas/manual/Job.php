...
<div class="wrap-rich-snippets-item wrap-rich-snippets-jobs">
    <div class="seopress-notice">
        <p>
            <?php esc_html_e('Adding structured data makes your job postings eligible to appear in a special user experience in Google Search results.', 'webseo'); ?>
        </p>
    </div>
    <p>
        ...
        <input type="text" id="seopress_pro_rich_snippets_jobs_name_meta"
            ...
            placeholder="<?php esc_html_e('The title of the job (not the title of the posting). For example, "Software Engineer" or "Barista".', 'webseo'); ?>"
            aria-label="<?php esc_html_e('Job title', 'webseo'); ?>"
    ...
    <p>
        ...
        <textarea rows="12" id="seopress_pro_rich_snippets_jobs_desc_meta"
            ...
            placeholder="<?php esc_html_e('The full description of the job in HTML format.', 'webseo'); ?>"
            aria-label="<?php esc_html_e('Job description', 'webseo'); ?>"><?php echo wp_kses_post($seopress_pro_rich_snippets_jobs_desc); ?></textarea>
    </p>
    <p>
        ...
        <input type="text" id="seopress-date-picker4" class="seopress-date-picker" autocomplete="off"
            ...
            placeholder="<?php esc_html_e('The original date that employer posted the job in ISO 8601 format. For example, "2017-01-24" or "2017-01-24T19:33:17+00:00".', 'webseo'); ?>"
            aria-label="<?php esc_html_e('Published date', 'webseo'); ?>"
    ...
    <p>
        ...
        <input type="text" id="seopress-date-picker5" class="seopress-date-picker" autocomplete="off"
            ...
            placeholder="<?php esc_html_e('The date when the job posting will expire in ISO 8601 format. For example, "2017-02-24" or "2017-02-24T19:33:17+00:00".', 'webseo'); ?>"
            aria-label="<?php esc_html_e('Expiration date', 'webseo'); ?>"
    ...
    <p class="seopress_pro_rich_snippets_jobs_employment_type_p">
        ...
        <input type="text" id="seopress_pro_rich_snippets_jobs_employment_type_meta"
            ...
            placeholder="<?php esc_html_e('Type of employment, You can include more than one employmentType property.', 'webseo'); ?>"
            aria-label="<?php esc_html_e('Type of employment', 'webseo'); ?>"
    ...
    <p>
        <label for="seopress_pro_rich_snippets_jobs_identifier_name_meta">
            <?php esc_html_e('Identifier name', 'webseo'); ?></label>
        <input type="text" id="seopress_pro_rich_snippets_jobs_identifier_name_meta"
            ...
            placeholder="<?php esc_html_e('The hiring organization\'s unique identifier name for the job', 'webseo'); ?>"
            aria-label="<?php esc_html_e('Identifier name', 'webseo'); ?>"
    ...
    <p>
        <label for="seopress_pro_rich_snippets_jobs_identifier_value_meta">
            <?php esc_html_e('Identifier value', 'webseo'); ?></label>
        <input type="number" id="seopress_pro_rich_snippets_jobs_identifier_value_meta" min="0"
            ...
            placeholder="<?php esc_html_e('The hiring organization\'s value identifier value for the job', 'webseo'); ?>"
            aria-label="<?php esc_html_e('Identifier value', 'webseo'); ?>"
    ...
    <p>
        <label for="seopress_pro_rich_snippets_jobs_hiring_organization_meta">
            <?php esc_html_e('Organization that hires', 'webseo'); ?>
        </label>
        <span class="description"><?php esc_html_e('Default: Organization name from your Knowledge Graph (SEO > Social Networks > Knowledge Graph)', 'webseo'); ?></span>
        <input type="text" id="seopress_pro_rich_snippets_jobs_hiring_organization_meta"
            ...
            placeholder="<?php esc_html_e('The organization offering the job position. This should be the name of the company.', 'webseo'); ?>"
            aria-label="<?php esc_html_e('Organization that hires', 'webseo'); ?>"
    ...
    <p>
        <label for="seopress_pro_rich_snippets_jobs_hiring_same_as_meta">
            <?php esc_html_e('Organization website', 'webseo'); ?>
        </label>
        <span class="description"><?php esc_html_e('Default: URL of your site', 'webseo'); ?></span>
        <input type="text" id="seopress_pro_rich_snippets_jobs_hiring_same_as_meta"
            ...
            placeholder="<?php esc_html_e('The organization website URL offering the job position.', 'webseo'); ?>"
            aria-label="<?php esc_html_e('Organization URL', 'webseo'); ?>"
    ...
    <p>
        <label for="seopress_pro_rich_snippets_jobs_hiring_logo_meta">
            <?php esc_html_e('Organization logo', 'webseo'); ?>
        </label>
        <span class="description"><?php esc_html_e('Default: Logo from your Knowledge Graph (SEO > Social Networks > Knowledge Graph)', 'webseo'); ?>
        </span>
        <input id="seopress_pro_rich_snippets_jobs_hiring_logo_meta" type="text"
            ...
            aria-label="<?php esc_html_e('Organization logo', 'webseo'); ?>"
    ...
    <p>
        ...
        <input type="text" id="seopress_pro_rich_snippets_jobs_address_street_meta"
            ...
            placeholder="<?php esc_html_e('Street address', 'webseo'); ?>"
    ...
    <p>
        <label for="seopress_pro_rich_snippets_jobs_address_locality_meta">
            <?php esc_html_e('Locality address', 'webseo'); ?>
        </label>
        <input type="text" id="seopress_pro_rich_snippets_jobs_address_locality_meta"
            ...
            placeholder="<?php esc_html_e('Locality address', 'webseo'); ?>"
            aria-label="<?php esc_html_e('Locality address', 'webseo'); ?>"
    ...
    <p>
        ...
        <input type="text" id="seopress_pro_rich_snippets_jobs_address_region_meta"
            ...
            placeholder="<?php esc_html_e('Region', 'webseo'); ?>"
            aria-label="<?php esc_html_e('Region', 'webseo'); ?>"
    ...
    <p>
        ...
        <input type="text" id="seopress_pro_rich_snippets_jobs_postal_code_meta"
            ...
            placeholder="<?php esc_html_e('Postal code', 'webseo'); ?>"
    ...
    <p>
        ...
        <input type="text" id="seopress_pro_rich_snippets_jobs_country_meta"
            ...
            placeholder="<?php esc_html_e('Country', 'webseo'); ?>"
    ...
    <p>
        <label for="seopress_pro_rich_snippets_jobs_remote_meta">
            <input type="checkbox" id="seopress_pro_rich_snippets_jobs_remote_meta"
                ...
                aria-label="<?php esc_html_e('Remote job', 'webseo'); ?>"
                <?php if ('1' == $seopress_pro_rich_snippets_jobs_remote) {
                echo 'checked="yes"';
            } ?>
            value="1"
            />
            <?php esc_html_e('Remote job?', 'webseo'); ?>
        </label>
    </p>
    <p>
        <label for="seopress_pro_rich_snippets_jobs_location_requirement_meta">
            <?php esc_html_e('Location requirement for remote job', 'webseo'); ?>
        </label>
        ...
        placeholder="<?php esc_html_e('e.g. FR for France', 'webseo'); ?>"
        aria-label="<?php esc_html_e('e.g. FR for France', 'webseo'); ?>"
    ...
    <p>
        <label for="seopress_pro_rich_snippets_jobs_direct_apply_meta">
            <input type="checkbox" id="seopress_pro_rich_snippets_jobs_direct_apply_meta"
                ...
                aria-label="<?php esc_html_e('Direct apply', 'webseo'); ?>"
                <?php if ('1' == $seopress_pro_rich_snippets_jobs_direct_apply) {
                echo 'checked="yes"';
            } ?>
            value="1"
            />
            <?php esc_html_e('Direct apply?', 'webseo'); ?>
        </label>
    </p>
    <p>
        <label for="seopress_pro_rich_snippets_jobs_salary_meta">
            <?php esc_html_e('Salary', 'webseo'); ?>
        </label>
        <input type="number" id="seopress_pro_rich_snippets_jobs_salary_meta" step="0.01" min="0"
            ...
            placeholder="<?php esc_html_e('e.g. 50.00', 'webseo'); ?>"
    ...
    <p>
        ...
        <input type="text" id="seopress_pro_rich_snippets_jobs_salary_currency_meta"
            ...
            placeholder="<?php esc_html_e('e.g. USD', 'webseo'); ?>"
            aria-label="<?php esc_html_e('Currency', 'webseo'); ?>"
    ...
    <p>
        <label for="seopress_pro_rich_snippets_jobs_salary_unit_meta">
            <?php esc_html_e('Select your unit text', 'webseo'); ?>
        </label>
