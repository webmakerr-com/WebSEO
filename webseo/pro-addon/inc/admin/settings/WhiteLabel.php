...
if (is_network_admin() && is_multisite()) {
    ...
    add_settings_field(
        ...
        __('Keep only the SEO management block from SEO dashboard', 'webseo'), // Title
    ...
    add_settings_field(
        ...
        __('Filter SEO admin menu dashicons', 'webseo'), // Title
    ...
    add_settings_field(
        ...
        __('Edit SEOPress item in admin bar', 'webseo'), // Title
    ...
    add_settings_field(
        ...
        __('Edit SEOPress title in main menu', 'webseo'), // Title
    ...
    add_settings_field(
        ...
        __('Hide SEOPress links / help icons', 'webseo'), // Title
    ...
    add_settings_field(
        ...
        __('Remove SEOPress menu/submenu pages/dashboard items', 'webseo'), // Title
    ...
    add_settings_field(
        ...
        __('Change plugin title in plugins list', 'webseo'), // Title
    ...
    add_settings_field(
        ...
        __('Change plugin title (PRO) in plugins list', 'webseo'), // Title
    ...
    add_settings_field(
        ...
        __('Change plugin description in plugins list', 'webseo'), // Title
    ...
    add_settings_field(
        ...
        __('Change plugin description (PRO) in plugins list', 'webseo'), // Title
    ...
    add_settings_field(
        ...
        __('Change plugin author in plugins list', 'webseo'), // Title
    ...
    add_settings_field(
        ...
        __('Change plugin website in plugins list', 'webseo'), // Title
    ...
    add_settings_field(
        ...
        __('Remove View details / notification update in plugin list', 'webseo'), // Title
