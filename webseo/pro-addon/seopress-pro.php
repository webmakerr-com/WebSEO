...
if ( ! defined( 'SEOPRESS_PRO_TEMPLATE_DIR' ) ) {
        define( 'SEOPRESS_PRO_TEMPLATE_DIR', defined( 'WEBSEO_TEMPLATE_DIR' ) ? WEBSEO_TEMPLATE_DIR : SEOPRESS_PRO_PLUGIN_DIR_PATH . 'templates' );
}

if ( ! defined( 'SEOPRESS_PRO_TEMPLATE_JSON_SCHEMAS' ) ) {
        $pro_template_dir = defined( 'WEBSEO_TEMPLATE_JSON_SCHEMAS' ) ? WEBSEO_TEMPLATE_JSON_SCHEMAS : SEOPRESS_PRO_TEMPLATE_DIR . '/json-schemas';
        define( 'SEOPRESS_PRO_TEMPLATE_JSON_SCHEMAS', $pro_template_dir );
}

if ( ! defined( 'SEOPRESS_PRO_TEMPLATE_STOP_WORDS' ) ) {
        $pro_template_stop_words = defined( 'WEBSEO_TEMPLATE_STOP_WORDS' ) ? WEBSEO_TEMPLATE_STOP_WORDS : SEOPRESS_PRO_TEMPLATE_DIR . '/stop-words';
        define( 'SEOPRESS_PRO_TEMPLATE_STOP_WORDS', $pro_template_stop_words );
}

if ( ! defined( 'SEOPRESS_PRO_LEGACY_TEMPLATE_DIR' ) ) {
        define( 'SEOPRESS_PRO_LEGACY_TEMPLATE_DIR', defined( 'WEBSEO_LEGACY_PRO_TEMPLATE_DIR' ) ? WEBSEO_LEGACY_PRO_TEMPLATE_DIR : SEOPRESS_PRO_PLUGIN_DIR_PATH . 'templates' );
}

if ( ! defined( 'SEOPRESS_PRO_LEGACY_TEMPLATE_JSON_SCHEMAS' ) ) {
        define( 'SEOPRESS_PRO_LEGACY_TEMPLATE_JSON_SCHEMAS', SEOPRESS_PRO_LEGACY_TEMPLATE_DIR . '/json-schemas' );
}

if ( ! defined( 'SEOPRESS_PRO_LEGACY_TEMPLATE_STOP_WORDS' ) ) {
        define( 'SEOPRESS_PRO_LEGACY_TEMPLATE_STOP_WORDS', SEOPRESS_PRO_LEGACY_TEMPLATE_DIR . '/stop-words' );
}
